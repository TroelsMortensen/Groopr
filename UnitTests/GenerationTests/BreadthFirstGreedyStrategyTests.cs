...
/// <summary>
/// Behavior that is specific to <see cref="BreadthFirstGreedyStrategy"/>
/// (shuffle-per-composition, wish expansion, random wish pick), not the shared producer contract.
/// </summary>
public class BreadthFirstGreedyStrategyTests
{
    ...
    private static BreadthFirstGreedyStrategy CreateStrategy(
    ...
    {
        var strategy = new BreadthFirstGreedyStrategy(
